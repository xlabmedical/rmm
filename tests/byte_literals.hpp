...
constexpr auto kilo{long long{1} << 10};
constexpr auto mega{long long{1} << 20};
constexpr auto giga{long long{1} << 30};
constexpr auto tera{long long{1} << 40};
constexpr auto peta{long long{1} << 50};
